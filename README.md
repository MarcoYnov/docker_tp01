...
J'ai voulu faire plus propre en créant un fichier .env que je copie dans le dockerfile.
La librairie dotenv-flow a été installée pour pouvoir lire la valeur de PORT

Commande à faire :
    - docker build -t name .
    - docker run -p 1337:1337 --hostname mydocker name
